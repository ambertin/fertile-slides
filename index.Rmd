...
4. How `fertile` works
5. Potential applications & Smith experiment
6. Conclusion
...
knitr::include_graphics("images/nature-1.jpeg")
```
...
- No absolute paths (starting @ root directory of computer / computer specific)

```{r, eval = FALSE}
"/Users/audreybertin/Documents/fertile-slides/images/fertile-hex.png"
```
...
- Education:
    ...
    3. Takes a lot of effort for professor to set up

- Software:

    1. Packages narrow in scope
    2. Complex functions, bad for new users, big learning curve
...
- `proj_move_files()`: R package structure
...
.small[
```{r, echo = FALSE}
knitr::include_graphics('images/components-summary.png')
```
]
...
```{r, echo = FALSE}
knitr::include_graphics('images/badges-2.png')
```
