...
- All paths should be written as relative to the project directory
    ...
    - No paths that point outside the project directory (e.g. to the desktop)
...
1. Inconsistent/weak
2. Authors lack time/knowledge
3. Costly for reviewers
...
- `orderly` / `drake`: automation, makefiles
...
Limiatations: 1. R packages narrow in scope, complex, big learning curve. 2. CI tools lack software specific features
